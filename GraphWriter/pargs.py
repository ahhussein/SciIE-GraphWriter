...
def pargs():
  ...
  parser.add_argument("-prop",default=4,type=int,help="number of layers/blocks")
  ...
  # TODO-new get it back to required
  parser.add_argument("-save", default='graph_dir',help="where to save model")
